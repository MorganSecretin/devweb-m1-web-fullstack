          ...
          <div class="bg-gray-50 p-4 rounded-lg">
            ...
            <div class="space-y-3">
              ...
              <div>
                ...
                <p class="text-gray-900">{{ applicant.person.birth | date:'dd/MM/yyyy' }}</p>
              </div>
              <div>
